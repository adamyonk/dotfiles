...
"let g:ctrlp_user_command = ['ag %s -l --nocolor -g ""'] " Specify an external tool to use for listing files instead of using Vim's |globpath()|. Use %s in place of the target directory
