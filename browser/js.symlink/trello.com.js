...
//        $card = $(this);
//
//    size = $card.find('.list-card-title').text().match(/\((.*)\)/);
//    if(size) {
//
//      badge = $('<div class="badge"/>').append('<span class="badge-text" style="color:#ffffff">'+size[1]+'</span>').css({backgroundColor: '#1c5b7f', borderColor: '#1c5b7f', paddingLeft: 4});
//      $card.find('.badges').prepend(badge);
//    };
//  });
//});
/*
