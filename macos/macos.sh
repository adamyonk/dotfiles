...
sudo scutil --set ComputerName "fabrikat"
sudo scutil --set HostName "fabrikat"
sudo scutil --set LocalHostName "fabrikat"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "fabrikat"
